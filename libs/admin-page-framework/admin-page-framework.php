...
/**
 ...
 Generated on 2019-08-17 */
if (!class_exists('LazyCoala_AdminPageFramework_Registry', false)):
    abstract class LazyCoala_AdminPageFramework_Registry_Base {
    ...
    final class LazyCoala_AdminPageFramework_Registry extends LazyCoala_AdminPageFramework_Registry_Base {
        ...
        static public function setUp($sFilePath = __FILE__) {
            ...
            self::$sAutoLoaderPath = isset(self::$aClassFiles['LazyCoala_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['LazyCoala_AdminPageFramework_RegisterClasses'] : '';
            self::$bIsMinifiedVersion = class_exists('LazyCoala_AdminPageFramework_MinifiedVersionHeader', false);
            self::$bIsDevelopmentVersion = isset(self::$aClassFiles['LazyCoala_AdminPageFramework_InclusionClassFilesHeader']);
        }
    ...
    if (!class_exists('LazyCoala_AdminPageFramework_Bootstrap', false)):
        final class LazyCoala_AdminPageFramework_Bootstrap {
            static private $_bLoaded = false;
            public function __construct($sLibraryPath) {
                if (!$this->_isLoadable()) {
                    return;
                }
                LazyCoala_AdminPageFramework_Registry::setUp($sLibraryPath);
                if (LazyCoala_AdminPageFramework_Registry::$bIsMinifiedVersion) {
                    return;
                }
                $this->_include();
            }
            ...
            private function _include() {
                include (LazyCoala_AdminPageFramework_Registry::$sAutoLoaderPath);
                new LazyCoala_AdminPageFramework_RegisterClasses('', array('exclude_class_names' => array('LazyCoala_AdminPageFramework_MinifiedVersionHeader', 'LazyCoala_AdminPageFramework_BeautifiedVersionHeader',),), LazyCoala_AdminPageFramework_Registry::$aClassFiles);
                self::$_bXDebug = isset(self::$_bXDebug) ? self::$_bXDebug : extension_loaded('xdebug');
                if (self::$_bXDebug) {
                    new LazyCoala_AdminPageFramework_Utility;
                    new LazyCoala_AdminPageFramework_WPUtility;
                }
            }
            static private $_bXDebug;
        }
        new LazyCoala_AdminPageFramework_Bootstrap(__FILE__);
    endif;
