...
abstract class LazyCoala_AdminPageFramework_PageMetaBox_Router extends LazyCoala_AdminPageFramework_MetaBox_View {
    ...
    abstract class LazyCoala_AdminPageFramework_PageMetaBox_Model extends LazyCoala_AdminPageFramework_PageMetaBox_Router {
    ...
    abstract class LazyCoala_AdminPageFramework_PageMetaBox_View extends LazyCoala_AdminPageFramework_PageMetaBox_Model {
    }
    abstract class LazyCoala_AdminPageFramework_PageMetaBox_Controller extends LazyCoala_AdminPageFramework_PageMetaBox_View {
    ...
    abstract class LazyCoala_AdminPageFramework_PageMetaBox extends LazyCoala_AdminPageFramework_PageMetaBox_Controller {
        protected $_sStructureType = 'page_meta_box';
        public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'LazyCoalaCodes') {
