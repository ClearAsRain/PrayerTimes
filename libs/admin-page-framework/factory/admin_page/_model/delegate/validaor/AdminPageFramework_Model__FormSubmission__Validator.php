...
class LazyCoala_AdminPageFramework_Model__FormSubmission__Validator_Base extends LazyCoala_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    ...
    class LazyCoala_AdminPageFramework_Model__FormSubmission__Validator extends LazyCoala_AdminPageFramework_Model__FormSubmission__Validator_Base {
        public $oFactory;
        ...
        public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
            ...
            $_aClassNames = array('LazyCoala_AdminPageFramework_Model__FormSubmission__Validator__Link', 'LazyCoala_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'LazyCoala_AdminPageFramework_Model__FormSubmission__Validator__Import', 'LazyCoala_AdminPageFramework_Model__FormSubmission__Validator__Export', 'LazyCoala_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'LazyCoala_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'LazyCoala_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'LazyCoala_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
            ...
            try {
                ...
                $_oFormSubmissionFilter = new LazyCoala_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
