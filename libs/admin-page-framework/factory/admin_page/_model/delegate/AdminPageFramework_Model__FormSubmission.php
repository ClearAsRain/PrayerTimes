...
abstract class LazyCoala_AdminPageFramework_Model__FormSubmission_Base extends LazyCoala_AdminPageFramework_Form_Utility {
    ...
    class LazyCoala_AdminPageFramework_Model__FormSubmission extends LazyCoala_AdminPageFramework_Model__FormSubmission_Base {
        public $oFactory;
        public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            $this->oFactory = $oFactory;
            $this->_handleFormData();
            new LazyCoala_AdminPageFramework_Model__FormRedirectHandler($oFactory);
        }
        public function _handleFormData() {
            ...
            new LazyCoala_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
