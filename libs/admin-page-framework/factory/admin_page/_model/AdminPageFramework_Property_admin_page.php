...
class LazyCoala_AdminPageFramework_Property_admin_page extends LazyCoala_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'LazyCoalaCodes') {
        ...
        $GLOBALS['aLazyCoala_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aLazyCoala_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aLazyCoala_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
