...
class LazyCoala_AdminPageFramework_Form_post_meta_box extends LazyCoala_AdminPageFramework_Form_Meta {
    public $sStructureType = 'post_meta_box';
    public function construct() {
        $this->_addDefaultResources();
    }
    private function _addDefaultResources() {
        $_oCSS = new LazyCoala_AdminPageFramework_Form_View___CSS_meta_box;
