...
abstract class LazyCoala_AdminPageFramework_MetaBox_Router extends LazyCoala_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'LazyCoalaCodes') {
    ...
    abstract class LazyCoala_AdminPageFramework_MetaBox_Model extends LazyCoala_AdminPageFramework_MetaBox_Router {
        public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'LazyCoalaCodes') {
        ...
        public function _replyToGetSavedFormData() {
            $_oMetaData = new LazyCoala_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
    ...
    abstract class LazyCoala_AdminPageFramework_MetaBox_View extends LazyCoala_AdminPageFramework_MetaBox_Model {
    ...
    abstract class LazyCoala_AdminPageFramework_MetaBox_Controller extends LazyCoala_AdminPageFramework_MetaBox_View {
    ...
    abstract class LazyCoala_AdminPageFramework_MetaBox extends LazyCoala_AdminPageFramework_MetaBox_Controller {
