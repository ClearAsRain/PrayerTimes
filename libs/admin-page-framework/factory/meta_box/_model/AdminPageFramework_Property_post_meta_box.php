...
class LazyCoala_AdminPageFramework_Property_post_meta_box extends LazyCoala_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'LazyCoalaCodes', $sStructureType = 'post_meta_box') {
