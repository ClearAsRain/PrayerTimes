...
abstract class LazyCoala_AdminPageFramework_UserMeta_Router extends LazyCoala_AdminPageFramework_Factory {
    ...
    abstract class LazyCoala_AdminPageFramework_UserMeta_Model extends LazyCoala_AdminPageFramework_UserMeta_Router {
        public function _replyToGetSavedFormData() {
            $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
            $_oMetaData = new LazyCoala_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
    ...
    abstract class LazyCoala_AdminPageFramework_UserMeta_View extends LazyCoala_AdminPageFramework_UserMeta_Model {
    ...
    abstract class LazyCoala_AdminPageFramework_UserMeta_Controller extends LazyCoala_AdminPageFramework_UserMeta_View {
    ...
    abstract class LazyCoala_AdminPageFramework_UserMeta extends LazyCoala_AdminPageFramework_UserMeta_Controller {
        protected $_sStructureType = 'user_meta';
        public function __construct($sCapability = 'read', $sTextDomain = 'LazyCoalaCodes') {
