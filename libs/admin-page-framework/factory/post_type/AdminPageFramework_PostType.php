...
abstract class LazyCoala_AdminPageFramework_PostType_Router extends LazyCoala_AdminPageFramework_Factory {
    ...
    abstract class LazyCoala_AdminPageFramework_PostType_Model extends LazyCoala_AdminPageFramework_PostType_Router {
        public function __construct($oProp) {
            parent::__construct($oProp);
            ...
            if ($this->oProp->bIsAdmin) {
                ...
                if ($this->oProp->sCallerPath) {
                    new LazyCoala_AdminPageFramework_PostType_Model__FlushRewriteRules($this);
                }
            }
        }
        ...
        public function _replyToRegisterPostType() {
            ...
            new LazyCoala_AdminPageFramework_PostType_Model__SubMenuOrder($this);
        }
    ...
    abstract class LazyCoala_AdminPageFramework_PostType_View extends LazyCoala_AdminPageFramework_PostType_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            if ($this->oProp->bIsAdmin) {
        ...
        public function _replyToPrintStyle() {
            ...
            if (!empty($this->oProp->sStyle)) {
                echo "<style type='text/css' id='LazyCoalaCodes-style-post-type'>" . $this->oProp->sStyle . "</style>";
            }
        }
    ...
    abstract class LazyCoala_AdminPageFramework_PostType_Controller extends LazyCoala_AdminPageFramework_PostType_View {
    ...
    abstract class LazyCoala_AdminPageFramework_PostType extends LazyCoala_AdminPageFramework_PostType_Controller {
        protected $_sStructureType = 'post_type';
        public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'LazyCoalaCodes') {
            if (empty($sPostType)) {
                return;
            }
            $_sProprtyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'LazyCoala_AdminPageFramework_Property_' . $this->_sStructureType;
            ...
            $this->oProp->sPostType = LazyCoala_AdminPageFramework_WPUtility::sanitizeSlug($sPostType);
            $this->oProp->aPostTypeArgs = $aArguments;
        ...
        private function _getCallerScriptPath($sCallerPath) {
            ...
            $_sPageNow = LazyCoala_AdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
            if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php', 'term.php'))) {
                return LazyCoala_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
            }
            return null;
        }
    }
