...
abstract class LazyCoala_AdminPageFramework_TermMeta_Router extends LazyCoala_AdminPageFramework_TaxonomyField_Controller {
    }
    abstract class LazyCoala_AdminPageFramework_TermMeta_Model extends LazyCoala_AdminPageFramework_TermMeta_Router {
        ...
        private function _getSavedTermMetas($iTermID, array $aFieldsets) {
            $_oMetaData = new LazyCoala_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
    ...
    abstract class LazyCoala_AdminPageFramework_TermMeta_View extends LazyCoala_AdminPageFramework_TermMeta_Model {
    ...
    abstract class LazyCoala_AdminPageFramework_TermMeta_Controller extends LazyCoala_AdminPageFramework_TermMeta_View {
    }
    abstract class LazyCoala_AdminPageFramework_TermMeta extends LazyCoala_AdminPageFramework_TermMeta_Controller {
        protected $_sStructureType = 'term_meta';
        public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'LazyCoalaCodes') {
