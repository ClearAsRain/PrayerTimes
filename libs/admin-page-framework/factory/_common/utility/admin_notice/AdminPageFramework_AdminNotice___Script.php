...
class LazyCoala_AdminPageFramework_AdminNotice___Script extends LazyCoala_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.LazyCoalaCodes-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='LazyCoalaCodes-admin-notice-animation-container'></div>" );
