...
class LazyCoala_AdminPageFramework_AdminNotice extends LazyCoala_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'LazyCoalaCodes-settings-notice-message', 'LazyCoalaCodes-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new LazyCoala_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
