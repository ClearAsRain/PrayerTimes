...
class LazyCoala_AdminPageFramework_FrameworkUtility extends LazyCoala_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = LazyCoala_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return LazyCoala_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
    }
    class LazyCoala_AdminPageFramework_ArrayHandler extends LazyCoala_AdminPageFramework_FrameworkUtility {
        public $aData = array();
