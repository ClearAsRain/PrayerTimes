...
class LazyCoala_AdminPageFramework_Debug_Base extends LazyCoala_AdminPageFramework_FrameworkUtility {
    ...
    class LazyCoala_AdminPageFramework_Debug_Log extends LazyCoala_AdminPageFramework_Debug_Base {
    ...
    class LazyCoala_AdminPageFramework_Debug extends LazyCoala_AdminPageFramework_Debug_Log {
        ...
        static public function dumpArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('LazyCoala_AdminPageFramework_Debug::' . __FUNCTION__, 'LazyCoala_AdminPageFramework_Debug::dump()');
            LazyCoala_AdminPageFramework_Debug::dump($asArray, $sFilePath);
        }
        static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
            self::showDeprecationNotice('LazyCoala_AdminPageFramework_Debug::' . __FUNCTION__, 'LazyCoala_AdminPageFramework_Debug::get()');
            return LazyCoala_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
        }
        static public function logArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('LazyCoala_AdminPageFramework_Debug::' . __FUNCTION__, 'LazyCoala_AdminPageFramework_Debug::log()');
            LazyCoala_AdminPageFramework_Debug::log($asArray, $sFilePath);
        }
        static public function getAsString($mValue) {
            self::showDeprecationNotice('LazyCoala_AdminPageFramework_Debug::' . __FUNCTION__);
