...
class LazyCoala_AdminPageFramework_FieldType_checkbox extends LazyCoala_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.LazyCoalaCodes-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.LazyCoalaCodes-checkbox-label {margin-top: 0.1em;}.LazyCoalaCodes-field input[type='checkbox' ] {margin-right: 0.5em;} .LazyCoalaCodes-field-checkbox .LazyCoalaCodes-input-label-container {padding-right: 1em;}.LazyCoalaCodes-field-checkbox .LazyCoalaCodes-input-label-string{display: inline; }";
    }
    ...
    class LazyCoala_AdminPageFramework_FieldType_posttype extends LazyCoala_AdminPageFramework_FieldType_checkbox {
        ...
        protected function getStyles() {
            ...
            return $_sParentStyles . ".LazyCoalaCodes-field input[type='checkbox'] {margin-right: 0.5em;} .LazyCoalaCodes-field-posttype .LazyCoalaCodes-input-label-container {padding-right: 1em;}";
        }
        protected function getField($aField) {
