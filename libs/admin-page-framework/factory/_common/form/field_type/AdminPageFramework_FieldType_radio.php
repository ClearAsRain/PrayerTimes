...
class LazyCoala_AdminPageFramework_FieldType_radio extends LazyCoala_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".LazyCoalaCodes-field input[type='radio'] {margin-right: 0.5em;} .LazyCoalaCodes-field-radio .LazyCoalaCodes-input-label-container {padding-right: 1em;} .LazyCoalaCodes-field-radio .LazyCoalaCodes-input-container {display: inline;} .LazyCoalaCodes-field-radio .LazyCoalaCodes-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.LazyCoalaCodes-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
