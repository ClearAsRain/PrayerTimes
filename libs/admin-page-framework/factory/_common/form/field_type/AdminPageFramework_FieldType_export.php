...
class LazyCoala_AdminPageFramework_FieldType_submit extends LazyCoala_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".LazyCoalaCodes-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'LazyCoalaCodes-input-label-container' . ' LazyCoalaCodes-input-button-container' . ' LazyCoalaCodes-input-container',);
    }
    ...
    class LazyCoala_AdminPageFramework_FieldType_export extends LazyCoala_AdminPageFramework_FieldType_submit {
