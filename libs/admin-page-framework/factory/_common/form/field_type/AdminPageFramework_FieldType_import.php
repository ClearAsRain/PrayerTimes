...
class LazyCoala_AdminPageFramework_FieldType_import extends LazyCoala_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".LazyCoalaCodes-field-import input {margin-right: 0.5em;}.LazyCoalaCodes-field-import label,.form-table td fieldset.LazyCoalaCodes-fieldset .LazyCoalaCodes-field-import label { display: inline; }";
    }
