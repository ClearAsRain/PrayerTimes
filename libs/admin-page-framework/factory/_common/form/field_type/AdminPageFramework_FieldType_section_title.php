...
class LazyCoala_AdminPageFramework_FieldType_section_title extends LazyCoala_AdminPageFramework_FieldType_text {
    ...
    protected function getStyles() {
        return ".LazyCoalaCodes-section-tab .LazyCoalaCodes-field-section_title {padding: 0.5em;} .LazyCoalaCodes-section-tab .LazyCoalaCodes-field-section_title .LazyCoalaCodes-input-label-string { vertical-align: middle; margin-left: 0.2em;}.LazyCoalaCodes-section-tab .LazyCoalaCodes-fields {display: inline-block;} .LazyCoalaCodes-field.LazyCoalaCodes-field-section_title {float: none;} .LazyCoalaCodes-field.LazyCoalaCodes-field-section_title input {background-color: #fff;color: #333;border-color: #ddd;box-shadow: inset 0 1px 2px rgba(0,0,0,.07);border-width: 1px;border-style: solid;outline: 0;box-sizing: border-box;vertical-align: middle;}";
    }
