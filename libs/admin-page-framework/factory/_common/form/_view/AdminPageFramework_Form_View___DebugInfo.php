...
class LazyCoala_AdminPageFramework_Form_View___DebugInfo extends LazyCoala_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='LazyCoalaCodes-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
