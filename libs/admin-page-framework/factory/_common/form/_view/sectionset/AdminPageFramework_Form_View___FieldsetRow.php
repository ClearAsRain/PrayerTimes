...
class LazyCoala_AdminPageFramework_Form_View___FieldsetTableRow extends LazyCoala_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        $_oFieldrowAttribute = new LazyCoala_AdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset, array('id' => 'fieldrow-' . $aFieldset['tag_id'], 'valign' => 'top', 'class' => 'LazyCoalaCodes-fieldrow',));
    ...
    protected function _getFieldByContainer(array $aFieldset, array $aOpenCloseTags) {
        ...
        $_oFieldTitle = new LazyCoala_AdminPageFramework_Form_View___FieldTitle($aFieldset, '', $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        $_aOutput = array();
    ...
    class LazyCoala_AdminPageFramework_Form_View___FieldsetRow extends LazyCoala_AdminPageFramework_Form_View___FieldsetTableRow {
        public $aFieldset = array();
        public $aSavedData = array();
        public $aFieldErrors = array();
        public $aFieldTypeDefinitions = array();
        ...
        public function get() {
            ...
            $_oFieldrowAttribute = new LazyCoala_AdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset);
