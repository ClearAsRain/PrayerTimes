...
class LazyCoala_AdminPageFramework_Form_View___Script_SectionTab extends LazyCoala_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.LazyCoalaCodes-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='LazyCoalaCodes-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
    }
