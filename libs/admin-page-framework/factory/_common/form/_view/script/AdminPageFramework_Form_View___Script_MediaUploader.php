...
class LazyCoala_AdminPageFramework_Form_View___Script_MediaUploader extends LazyCoala_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
    ...
    getLazyCoala_AdminPageFrameworkCustomMediaUploaderSelectObject = function() {
