...
class LazyCoala_AdminPageFramework_Form_View___Script_Widget extends LazyCoala_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.LazyCoalaCodes-sectionset' ).length <= 0 ) { 
                    return; 
                }   
