...
class LazyCoala_AdminPageFramework_Form_View___Script_CheckboxSelector extends LazyCoala_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
     ...
     */        
    $.fn.selectAllLazyCoala_AdminPageFrameworkCheckboxes = function() {
        jQuery( this ).parent()
     ...
     */
    $.fn.deselectAllLazyCoala_AdminPageFrameworkCheckboxes = function() {
        jQuery( this ).parent()
            .find( 'input[type=checkbox]' )
            .attr( 'checked', false )
            .trigger( 'change' );   // 3.8.8+
