...
class LazyCoala_AdminPageFramework_Form_View___Script_Form extends LazyCoala_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removeLazyCoala_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.LazyCoalaCodes-form-loading' ).remove();
        jQuery( '.LazyCoalaCodes-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.LazyCoalaCodes-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removeLazyCoala_AdminPageFrameworkLoadingOutputs();
