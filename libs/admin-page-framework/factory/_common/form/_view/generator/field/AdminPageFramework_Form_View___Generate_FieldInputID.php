...
class LazyCoala_AdminPageFramework_Form_View___Generate_FieldTagID extends LazyCoala_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
    ...
    class LazyCoala_AdminPageFramework_Form_View___Generate_FieldInputID extends LazyCoala_AdminPageFramework_Form_View___Generate_FieldTagID {
        public $isIndex = '';
