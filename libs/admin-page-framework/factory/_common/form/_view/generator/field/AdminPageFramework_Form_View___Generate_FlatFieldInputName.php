...
class LazyCoala_AdminPageFramework_Form_View___Generate_FieldInputName extends LazyCoala_AdminPageFramework_Form_View___Generate_FlatFieldName {
    public $sIndex = '';
    ...
    class LazyCoala_AdminPageFramework_Form_View___Generate_FlatFieldInputName extends LazyCoala_AdminPageFramework_Form_View___Generate_FieldInputName {
        public function get() {
            $_sIndex = $this->getAOrB('0' !== $this->sIndex && empty($this->sIndex), '', "|{$this->sIndex}");
