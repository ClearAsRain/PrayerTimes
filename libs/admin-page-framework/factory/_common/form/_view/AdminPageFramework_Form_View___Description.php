...
class LazyCoala_AdminPageFramework_Form_View___Description extends LazyCoala_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'LazyCoalaCodes-form-element-description';
