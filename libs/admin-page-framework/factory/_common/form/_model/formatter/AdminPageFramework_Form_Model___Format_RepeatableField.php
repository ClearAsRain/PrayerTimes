...
class LazyCoala_AdminPageFramework_Form_Model___Format_RepeatableSection extends LazyCoala_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : LazyCoala_AdminPageFramework_Message::getInstance();
    }
    public function get() {
    ...
    class LazyCoala_AdminPageFramework_Form_Model___Format_RepeatableField extends LazyCoala_AdminPageFramework_Form_Model___Format_RepeatableSection {
        protected function _getDefaultMessage() {
