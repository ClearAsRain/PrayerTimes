...
class LazyCoala_AdminPageFramework_Form_Model___SetFieldResources extends LazyCoala_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new LazyCoala_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('LazyCoala_AdminPageFramework_Form_View___CSS_Form', 'LazyCoala_AdminPageFramework_Form_View___CSS_Field', 'LazyCoala_AdminPageFramework_Form_View___CSS_Section', 'LazyCoala_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'LazyCoala_AdminPageFramework_Form_View___CSS_FieldError', 'LazyCoala_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('LazyCoala_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new LazyCoala_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new LazyCoala_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
