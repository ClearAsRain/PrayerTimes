...
abstract class LazyCoala_AdminPageFramework_Form_Utility extends LazyCoala_AdminPageFramework_FrameworkUtility {
    ...
    static public function getFieldsetReformattedBySubFieldIndex($aFieldset, $iSubFieldIndex, $bHasSubFields, $aParentFieldset) {
        ...
        $_oFieldsetFormatter = new LazyCoala_AdminPageFramework_Form_Model___Format_Fieldset($aFieldset, $aFieldset['_structure_type'], $aFieldset['capability'], ( integer )$iSubFieldIndex + 1, $aFieldset['_subsection_index'], $aFieldset['_is_section_repeatable'], $aFieldset['_caller_object']);
        $aFieldset = $_oFieldsetFormatter->get();
        $_oFieldsetOutputFormatter = new LazyCoala_AdminPageFramework_Form_Model___Format_FieldsetOutput($aFieldset, $aFieldset['_section_index'], $_oCallerForm->aFieldTypeDefinitions);
    ...
    abstract class LazyCoala_AdminPageFramework_Form_Base extends LazyCoala_AdminPageFramework_Form_Utility {
    ...
    class LazyCoala_AdminPageFramework_Form_Model extends LazyCoala_AdminPageFramework_Form_Base {
        ...
        public function getSortedInputs(array $aFormInputs) {
            ...
            $_oInputSorter = new LazyCoala_AdminPageFramework_Form_Model___Modifier_SortInput($aFormInputs, $_aDynamicFieldAddressKeys);
        ...
        public function dropRepeatableElements(array $aSubject) {
            $_oFilterRepeatableElements = new LazyCoala_AdminPageFramework_Form_Model___Modifier_FilterRepeatableElements($aSubject, $this->getElementAsArray($_POST, '__repeatable_elements_' . $this->aArguments['structure_type']));
        ...
        public function _replyToRegisterFormItems() {
            ...
            $_oFieldResources = new LazyCoala_AdminPageFramework_Form_Model___SetFieldResources($this->aArguments, $this->aFieldsets, self::$_aResources, $this->aFieldTypeDefinitions, $this->aCallbacks);
        ...
        private function _setSiteWideFieldTypeDefinitions() {
            ...
            $_oBuiltInFieldTypeDefinitions = new LazyCoala_AdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions('admin_page_framework', $this->oMsg);
        ...
        public function getDefaultFormValues() {
            $_oDefaultValues = new LazyCoala_AdminPageFramework_Form_Model___DefaultValues($this->aFieldsets);
            return $_oDefaultValues->get();
        }
        protected function _formatElementDefinitions(array $aSavedData) {
            $_oSectionsetsFormatter = new LazyCoala_AdminPageFramework_Form_Model___FormatSectionsets($this->aSectionsets, $this->aArguments['structure_type'], $this->sCapability, $this->aCallbacks, $this);
            $this->aSectionsets = $_oSectionsetsFormatter->get();
            $_oFieldsetsFormatter = new LazyCoala_AdminPageFramework_Form_Model___FormatFieldsets($this->aFieldsets, $this->aSectionsets, $this->aArguments['structure_type'], $this->aSavedData, $this->sCapability, $this->aCallbacks, $this);
    ...
    class LazyCoala_AdminPageFramework_Form_View extends LazyCoala_AdminPageFramework_Form_Model {
        public function __construct() {
            parent::__construct();
            new LazyCoala_AdminPageFramework_Form_View__Resource($this);
        }
        public function get() {
            ...
            new LazyCoala_AdminPageFramework_Form_View___Script_Form;
            $_oFormTables = new LazyCoala_AdminPageFramework_Form_View___Sectionsets(array('capability' => $this->sCapability,) + $this->aArguments, array('field_type_definitions' => $this->aFieldTypeDefinitions, 'sectionsets' => $this->aSectionsets, 'fieldsets' => $this->aFieldsets,), $this->aSavedData, $this->callBack($this->aCallbacks['field_errors'], array($this->getFieldErrors())), $this->aCallbacks, $this->oMsg);
        ...
        private function _getNoScriptMessage() {
            ...
            return "<noscript>" . "<div class='error'>" . "<p class='LazyCoalaCodes-form-warning'>" . $this->oMsg->get('please_enable_javascript') . "</p>" . "</div>" . "</noscript>";
        }
        public function printSubmitNotices() {
            $this->oSubmitNotice->render();
        }
    }
    class LazyCoala_AdminPageFramework_Form_Controller extends LazyCoala_AdminPageFramework_Form_View {
    ...
    class LazyCoala_AdminPageFramework_Form extends LazyCoala_AdminPageFramework_Form_Controller {
        ...
        public $oFieldError;
        public $oLastInputs;
        public $aSubClasses = array('submit_notice' => 'LazyCoala_AdminPageFramework_Form___SubmitNotice', 'field_error' => 'LazyCoala_AdminPageFramework_Form___FieldError', 'last_input' => 'LazyCoala_AdminPageFramework_Form_Model___LastInput', 'message' => 'LazyCoala_AdminPageFramework_Message',);
        public function __construct() {
