...
class LazyCoala_AdminPageFramework_Message {
    ...
    protected $_sTextDomain = 'LazyCoalaCodes';
    static private $_aInstancesByTextDomain = array();
    public static function getInstance($sTextDomain = 'LazyCoalaCodes') {
        $_oInstance = isset(self::$_aInstancesByTextDomain[$sTextDomain]) && (self::$_aInstancesByTextDomain[$sTextDomain] instanceof LazyCoala_AdminPageFramework_Message) ? self::$_aInstancesByTextDomain[$sTextDomain] : new LazyCoala_AdminPageFramework_Message($sTextDomain);
        self::$_aInstancesByTextDomain[$sTextDomain] = $_oInstance;
        return self::$_aInstancesByTextDomain[$sTextDomain];
    }
    public static function instantiate($sTextDomain = 'LazyCoalaCodes') {
        return self::getInstance($sTextDomain);
    }
    public function __construct($sTextDomain = 'LazyCoalaCodes') {
    ...
    private function ___doDummy() {
        __('The options have been updated.', 'LazyCoalaCodes');
        __('The options have been cleared.', 'LazyCoalaCodes');
        __('Export', 'LazyCoalaCodes');
        __('Export Options', 'LazyCoalaCodes');
        __('Import', 'LazyCoalaCodes');
        __('Import Options', 'LazyCoalaCodes');
        __('Submit', 'LazyCoalaCodes');
        __('An error occurred while uploading the import file.', 'LazyCoalaCodes');
        __('The uploaded file type is not supported: %1$s', 'LazyCoalaCodes');
        __('Could not load the importing data.', 'LazyCoalaCodes');
        __('The uploaded file has been imported.', 'LazyCoalaCodes');
        __('No data could be imported.', 'LazyCoalaCodes');
        __('Upload Image', 'LazyCoalaCodes');
        __('Use This Image', 'LazyCoalaCodes');
        __('Insert from URL', 'LazyCoalaCodes');
        __('Are you sure you want to reset the options?', 'LazyCoalaCodes');
        __('Please confirm your action.', 'LazyCoalaCodes');
        __('The specified options have been deleted.', 'LazyCoalaCodes');
        __('A problem occurred while processing the form data. Please try again.', 'LazyCoalaCodes');
        __('Not all form fields could not be sent. Please check your server settings of PHP <code>max_input_vars</code> and consult the server administrator to increase the value. <code>max input vars</code>: %1$s. <code>$_POST</code> count: %2$s', 'LazyCoalaCodes');
        __('Is it okay to send the email?', 'LazyCoalaCodes');
        __('The email has been sent.', 'LazyCoalaCodes');
        __('The email has been scheduled.', 'LazyCoalaCodes');
        __('There was a problem sending the email', 'LazyCoalaCodes');
        __('Title', 'LazyCoalaCodes');
        __('Author', 'LazyCoalaCodes');
        __('Categories', 'LazyCoalaCodes');
        __('Tags', 'LazyCoalaCodes');
        __('Comments', 'LazyCoalaCodes');
        __('Date', 'LazyCoalaCodes');
        __('Show All', 'LazyCoalaCodes');
        __('Show All Authors', 'LazyCoalaCodes');
        __('Thank you for creating with', 'LazyCoalaCodes');
        __('and', 'LazyCoalaCodes');
        __('Settings', 'LazyCoalaCodes');
        __('Manage', 'LazyCoalaCodes');
        __('Select Image', 'LazyCoalaCodes');
        __('Upload File', 'LazyCoalaCodes');
        __('Use This File', 'LazyCoalaCodes');
        __('Select File', 'LazyCoalaCodes');
        __('Remove Value', 'LazyCoalaCodes');
        __('Select All', 'LazyCoalaCodes');
        __('Select None', 'LazyCoalaCodes');
        __('No term found.', 'LazyCoalaCodes');
        __('Select', 'LazyCoalaCodes');
        __('Insert', 'LazyCoalaCodes');
        __('Use This', 'LazyCoalaCodes');
        __('Return to Library', 'LazyCoalaCodes');
        __('%1$s queries in %2$s seconds.', 'LazyCoalaCodes');
        __('%1$s out of %2$s MB (%3$s) memory used.', 'LazyCoalaCodes');
        __('Peak memory usage %1$s MB.', 'LazyCoalaCodes');
        __('Initial memory usage  %1$s MB.', 'LazyCoalaCodes');
        __('The allowed maximum number of fields is {0}.', 'LazyCoalaCodes');
        __('The allowed minimum number of fields is {0}.', 'LazyCoalaCodes');
        __('Add', 'LazyCoalaCodes');
        __('Remove', 'LazyCoalaCodes');
        __('The allowed maximum number of sections is {0}', 'LazyCoalaCodes');
        __('The allowed minimum number of sections is {0}', 'LazyCoalaCodes');
        __('Add Section', 'LazyCoalaCodes');
        __('Remove Section', 'LazyCoalaCodes');
        __('Toggle All', 'LazyCoalaCodes');
        __('Toggle all collapsible sections', 'LazyCoalaCodes');
        __('Reset', 'LazyCoalaCodes');
        __('Yes', 'LazyCoalaCodes');
        __('No', 'LazyCoalaCodes');
        __('On', 'LazyCoalaCodes');
        __('Off', 'LazyCoalaCodes');
        __('Enabled', 'LazyCoalaCodes');
        __('Disabled', 'LazyCoalaCodes');
        __('Supported', 'LazyCoalaCodes');
        __('Not Supported', 'LazyCoalaCodes');
        __('Functional', 'LazyCoalaCodes');
        __('Not Functional', 'LazyCoalaCodes');
        __('Too Long', 'LazyCoalaCodes');
        __('Acceptable', 'LazyCoalaCodes');
        __('No log found.', 'LazyCoalaCodes');
        __('The method is called too early: %1$s', 'LazyCoalaCodes');
        __('Debug Info', 'LazyCoalaCodes');
        __('Click here to expand to view the contents.', 'LazyCoalaCodes');
        __('Click here to collapse the contents.', 'LazyCoalaCodes');
        __('Loading...', 'LazyCoalaCodes');
        __('Please enable JavaScript for better user experience.', 'LazyCoalaCodes');
        __('Debug', 'LazyCoalaCodes');
        __('Field Arguments', 'LazyCoalaCodes');
        __('This information will be disabled when <code>WP_DEBUG</code> is set to <code>false</code> in <code>wp-config.php</code>.', 'LazyCoalaCodes');
        __('Section Arguments', 'LazyCoalaCodes');
        __('The ability to repeat sections is disabled.', 'LazyCoalaCodes');
        __('The ability to repeat fields is disabled.', 'LazyCoalaCodes');
        __('Warning.', 'LazyCoalaCodes');
    }
    }
