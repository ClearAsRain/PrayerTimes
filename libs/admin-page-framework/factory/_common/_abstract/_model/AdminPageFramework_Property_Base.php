...
abstract class LazyCoala_AdminPageFramework_Property_Base extends LazyCoala_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'LazyCoalaCodes' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aLazyCoala_AdminPageFramework'])) {
            $GLOBALS['aLazyCoala_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => LazyCoala_AdminPageFramework_Registry::NAME, 'sURI' => LazyCoala_AdminPageFramework_Registry::URI, 'sScriptName' => LazyCoala_AdminPageFramework_Registry::NAME, 'sLibraryName' => LazyCoala_AdminPageFramework_Registry::NAME, 'sLibraryURI' => LazyCoala_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => LazyCoala_AdminPageFramework_Registry::getVersion(), 'sDescription' => LazyCoala_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => LazyCoala_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => LazyCoala_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => LazyCoala_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => LazyCoala_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new LazyCoala_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
    }
