...
abstract class LazyCoala_AdminPageFramework_Widget_Router extends LazyCoala_AdminPageFramework_Factory {
    ...
    abstract class LazyCoala_AdminPageFramework_Widget_Model extends LazyCoala_AdminPageFramework_Widget_Router {
        ...
        public function _replyToRegisterWidget() {
            ...
            $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName] = new LazyCoala_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
            $this->oProp->oWidget = $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName];
        }
    }
    abstract class LazyCoala_AdminPageFramework_Widget_View extends LazyCoala_AdminPageFramework_Widget_Model {
    ...
    abstract class LazyCoala_AdminPageFramework_Widget_Controller extends LazyCoala_AdminPageFramework_Widget_View {
    ...
    abstract class LazyCoala_AdminPageFramework_Widget extends LazyCoala_AdminPageFramework_Widget_Controller {
        protected $_sStructureType = 'widget';
        public function __construct() {
            $_sThisClassName = get_class($this);
            $_bAssumedAsWPWidget = 0 === func_num_args();
            $_aDefaults = array('', array(), 'edit_theme_options', 'LazyCoalaCodes');
