...
class LazyCoala_AdminPageFramework_Property_widget extends LazyCoala_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'LazyCoalaCodes', $sStructureType) {
