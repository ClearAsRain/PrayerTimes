...
abstract class LazyCoala_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('LazyCoala_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new LazyCoala_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
