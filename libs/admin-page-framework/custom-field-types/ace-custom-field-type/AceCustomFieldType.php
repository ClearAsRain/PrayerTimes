<?php
/**
 * LazyCoala_AceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'LazyCoala_AceCustomFieldType' ) ) :
class LazyCoala_AceCustomFieldType extends LazyCoala_AdminPageFramework_FieldType {
            ...
            jQuery().registerAPFCallback( {
                ...
                */
                added_repeatable_field: function( oCopied, sFieldType, sFieldTagID, iCallType ) {
                    ...
                    oCopied.closest( '.LazyCoalaCodes-field' ).nextAll().andSelf().each( function( iIndex ) {
