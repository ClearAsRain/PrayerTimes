...
if ( ! class_exists( 'LazyCoala_ToggleCustomFieldType' ) ) :
/**
 ...
 */
class LazyCoala_ToggleCustomFieldType extends LazyCoala_AdminPageFramework_FieldType_checkbox {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery( '.switch_toggle_buttons' ).each( function () {
                ...
                jQuery( this ).closest( '.LazyCoalaCodes-field' )
                    .children( '.LazyCoalaCodes-checkbox-container-toggle' )
                    .hide();
