...
if ( ! class_exists( 'LazyCoala_Select2CustomFieldType' ) ) :
/**
 ...
 */
class LazyCoala_Select2CustomFieldType extends LazyCoala_AdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.LazyCoalaCodes-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.LazyCoalaCodes-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.LazyCoalaCodes-select-label' )
                .children( 'label' )
                .children( '.LazyCoalaCodes-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set initial values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.LazyCoalaCodes-field' )
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.LazyCoalaCodes-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    protected function getStyles() {
        return "
.LazyCoalaCodes-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}

.LazyCoalaCodes-field-select2 {
    max-width: 96%;
}

/* Make a room for repeatable buttons */
.repeatable .LazyCoalaCodes-field-select2 > .LazyCoalaCodes-select-label > label > .LazyCoalaCodes-input-container {
    max-width: 84%;
}
