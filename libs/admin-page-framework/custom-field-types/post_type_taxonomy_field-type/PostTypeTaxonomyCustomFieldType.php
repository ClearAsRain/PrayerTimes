 ...
 * @package     LazyCoala_AdminPageFramework
 */

if ( ! class_exists( 'LazyCoala_PostTypeTaxonomyCustomFieldType' ) ) :
/**
 ...
 */
class LazyCoala_PostTypeTaxonomyCustomFieldType extends LazyCoala_AdminPageFramework_FieldType_taxonomy {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '.LazyCoalaCodes-checkbox-container-posttype[data-select_all_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllLazyCoala_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '.LazyCoalaCodes-checkbox-container-posttype[data-select_none_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllLazyCoala_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
    
    // When the post type check-boxes are clicked, show/hide the corresponding taxonomy elements.
    jQuery( document ).on( 'change', '.LazyCoalaCodes-field-post_type_taxonomy .LazyCoalaCodes-field-posttype input[type="checkbox"]', function() {
        ...
        var _oField              = jQuery( this ).closest( '.LazyCoalaCodes-field-post_type_taxonomy' );
    ...
    jQuery( '.LazyCoalaCodes-field-post_type_taxonomy .LazyCoalaCodes-field-posttype input[type="checkbox"]:not(:checked)' ).each( function(){
        jQuery( this ).trigger( 'change' );
    } );
    

    jQuery().registerLazyCoala_AdminPageFrameworkCallbacks( {
        /**
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( '.LazyCoalaCodes-field-posttype input[type="checkbox"]' )
                .prop( 'checked', false )
                .trigger( 'change' );         
...
.LazyCoalaCodes-field-post_type_taxonomy .select_all_button_container, 
.LazyCoalaCodes-field-post_type_taxonomy .select_none_button_container
{
...
.LazyCoalaCodes-field-post_type_taxonomy .select-taxonomy-terms-checkbox-container {
            ...
            return "<div class='select-taxonomy-terms-checkbox-container'>"
                    . "<label class='select-taxonomy-terms'>"
                        ...
                        . "<input " . $this->getAttributes( $_aCheckboxAttributes ) . " />"
                            . __( 'Select taxonomy terms.', 'LazyCoalaCodes-loader' )
                    . "</label>"
                . "</div>";
