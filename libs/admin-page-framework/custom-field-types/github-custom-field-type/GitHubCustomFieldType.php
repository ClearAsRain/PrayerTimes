<?php
if ( ! class_exists( 'LazyCoala_GitHubCustomFieldType' ) ) :
/**
 * @version     1.0.1
 */
class LazyCoala_GitHubCustomFieldType extends LazyCoala_AdminPageFramework_FieldType {
    ...
    protected function getField( $aField ) { 
        ...
        return 
            $aField['before_label']
            . "<div class='LazyCoalaCodes-input-label-container'>"        
                . $aField['before_input']
                . ( $aField['label'] && ! $aField['repeatable']
                    ? "<span class='LazyCoalaCodes-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label'] . "</span>"
                    : "" 
                )
        ...
        private function _getButtonLabelByType( $sButtonType, $sUserName, $sValue ) {
            ...
            switch( $sButtonType ) {
                case 'follow': 
                    return sprintf( __( 'Follow @%1$s', 'LazyCoalaCodes' ), $sUserName );
                case 'watch':
                    return __( 'Watch', 'LazyCoalaCodes' );
                case 'star':
                    return __( 'Star', 'LazyCoalaCodes' );
                case 'fork':
                    return __( 'Fork', 'LazyCoalaCodes' );
                case 'issue':
                    return __( 'Issue', 'LazyCoalaCodes' );
                default:
                    return '';
            }                 
